...
def pop3(host, port, usr, pwd, use_ssl):
    ...
    for i in range(1, msg_num + 1):
        ...
        try:
            ...
            print
            "[-] Retrieve email {0} failed: {1}".format(i, e)
            continue
        ...
        try:
            ...
            print
            "[-] Read buffer of email {0} failed: {1}".format(i, e)
            continue
...
def imap4(host, port, usr, pwd, use_ssl):
    ...
    for folder in folders:
        ...
        try:
            ...
            print
            "[-] Parse folder {0} failed: {1}".format(folder, e)
            continue
        ...
        try:
            ...
            print
            "[-] Search folder {0} failed: {1}".format(folder_name, e)
            continue
        ...
        for i in msg_id_list:
            print
            "[*] Downloading email {0}/{1}".format(i, msg_num)
            ...
            try:
                ...
                if msg_md5 in download_hash:
                    print
                    "[-] This email has been downloaded in other folder"
                    continue
                else:
                ...
                print
                "[-] Parse message md5 failed: {0}".format(e)
                continue
            ...
            try:
                ...
                print
                "[-] Parse email {0} failed: {1}".format(i, e)
